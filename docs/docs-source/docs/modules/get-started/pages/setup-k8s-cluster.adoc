...
* AKS: `az aks get-credentials --resource-group myResourceGroup --name myAKSCluster`. For more details, refer to the https://docs.microsoft.com/en-us/azure/aks/kubernetes-walkthrough[AKS documentation].
